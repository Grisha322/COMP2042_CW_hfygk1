...
public class LevelOneSettings extends LevelSettings{
	...
	public void initHashMap() {
		...
		settings.put(LevelKeys.AMOUNT_OF_LOGS, 4.0);
		settings.put(LevelKeys.AMOUNT_OF_LONG_LOGS, 2.0);
		settings.put(LevelKeys.AMOUNT_OF_TURTLES, 2.0);
		...
		settings.put(LevelKeys.SPEED_OF_WET_TURTLES, -0.5);
		...
		settings.put(LevelKeys.DISTANCE_BETWEEN_TURTLES, 100.0);
		settings.put(LevelKeys.DISTANCE_BETWEEN_WET_TURTLES, 80.0);
	}
}
